...
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "archive1")
...
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleech1")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "unzip1"
)
